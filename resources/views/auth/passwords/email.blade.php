                    ...
                    <div style="background: #00acd4" class="qodef-page-title qodef-m qodef-title--breadcrumbs qodef-alignment--left qodef-vertical-alignment--header-bottom">
                        <div class="qodef-m-inner">
                           <div class="qodef-m-content qodef-content-grid ">
                              <div itemprop="breadcrumb" class="qodef-breadcrumbs"><a itemprop="url" class="qodef-breadcrumbs-link" href="{{route("index")}}"><span itemprop="title">Home</span></a><span class="qodef-breadcrumbs-separator"></span><span itemprop="title" class="qodef-breadcrumbs-current">Change Password</span></div>
                           </div>
                        </div>
                     </div>
                                     ...
                                     <div class="elementor-widget-container">
                                        <div class="qodef-contact-form-7  qodef-button-layout--filled-one">
                                           <div role="form" class="wpcf7" id="wpcf7-f2376-p1936-o1" lang="en-US" dir="ltr">
                                             ...
                                             <br>
                                             @endif
                                            <form action="{{ route('investor.password.change') }}" method="POST" class="wpcf7-form init cf7mls-no-scroll cf7mls-no-moving-animation" novalidate="novalidate" data-status="init">
                                                @csrf 
                                                @method("POST")
                                                <div class="qodef-m-two-cols qodef--mixed qodef-grid qodef-layout--columns qodef-col-num--2 qodef-responsive--custom qodef-col-num--1440--2 qodef-col-num--1366--2 qodef-col-num--1024--2 qodef-col-num--768--1 qodef-col-num--680--1 qodef-col-num--480--1">
                                                    <div class="qodef-grid-inner">
                                                        <div class="qodef-grid-item">
                                                            <span class="wpcf7-form-control-wrap"><input type="password" name="oldpassword" size="40" class="wpcf7-form-control" placeholder="Old Password" /></span>
                                                         </div>
                                                        <div class="qodef-grid-item">
                                                            <span class="wpcf7-form-control-wrap"><input type="password" name="password" size="40" class="wpcf7-form-control" placeholder="New Password" /></span>
                                                         </div>
                                                        <div class="qodef-grid-item">
                                                            <span class="wpcf7-form-control-wrap"><input type="password" name="password_confirmation" size="40" class="wpcf7-form-control" placeholder="Password Confirmation" /></span>
                                                        </div>
                                                    </div>
                                                 </div>
                                                 <br>
                                                 <button type="submit" class="wpcf7-form-control wpcf7-submit qodef-button qodef-size--normal qodef-m"><span class="qodef-m-text" id="contact_us_submit">Change Password</span></button>
                                            </form>
