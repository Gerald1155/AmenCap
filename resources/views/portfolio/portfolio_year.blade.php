                     ...
                     <div class="elementor-widget-container">
                        <div class="qodef-shortcode qodef-m  qodef-section-title qodef-alignment--left  ">
                           <h6 class="qodef-m-tagline">
                              {{-- @if ($year_balence[0]->balence_percentage > 0)
                                 Balence Of The Year : <img src="{{asset("icons/profit.png")}}" width="30" alt="icons"> <span style="color:lawngreen">{{$year_balence[0]->balence_percentage}}%</span> - <span style="color: #14203b"> ${{number_format($year_balence[0]->balence)}} </span>
                              @else
                                 Balence Of The Year : <img src="{{asset("icons/loss.png")}}" width="30" alt="icons"> <span style="color:red">{{$year_balence[0]->balence_percentage}}%</span> - <span style="color: #14203b"> ${{number_format($year_balence[0]->balence)}} </span>
                              @endif --}}
                           </h6>
                           <h2 class="qodef-m-title" id="time_stamp">
                              Chart of The Year 
                           </h2>
                            @foreach ($year_balence as $year)
                            <input type="hidden" class="balence_year" value="{{$year->balence}}">
                            @endforeach
                            @foreach ($year_balence as $year)
                            <input type="hidden" class="balence_year_dates" value="{{$year->time}}">
                            @endforeach
                           ...
                           crossorigin="anonymous"></script>
                           <script src="{{asset("js/year_chart.js")}}"></script>
                        </div>
                     </div>
                  </div>
                  <br>
