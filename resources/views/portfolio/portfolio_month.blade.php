                        ...
                        <div class="qodef-shortcode qodef-m  qodef-section-title qodef-alignment--left  ">
                           <h6 class="qodef-m-tagline">
                              @if ($month_balence[0]->balence_percentage > 0)
                                 Balence Of Last 30 Days : <img src="{{asset("icons/profit.png")}}" width="30" alt="icons"> <span style="color:lawngreen">{{$month_balence[0]->balence_percentage}}%</span> - <span style="color: #14203b"> ${{number_format($month_balence[0]->balence)}} </span>
                              @else
                                 Balence Of Last 30 Days : <img src="{{asset("icons/loss.png")}}" width="30" alt="icons"> <span style="color:red">{{$month_balence[0]->balence_percentage}}%</span> - <span style="color: #14203b"> ${{number_format($month_balence[0]->balence)}} </span>
                              @endif
                           </h6>
                           <h2 class="qodef-m-title" id="time_stamp">
                            ...
                            <input type="hidden" class="balence_month" value="{{$month->balence}}">
                            @endforeach
                            @foreach ($month_balence as $month)
                            <input type="hidden" class="balence_month_dates" value="{{$month->time}}">
                            @endforeach
                           ...
                           crossorigin="anonymous"></script>
                           <script src="{{asset("js/month_chart.js")}}"></script>
                        </div>
                     </div>
                  </div>
                  <h2 class="qodef-m-title" id="time_stamp">
