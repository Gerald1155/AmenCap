                     ...
                     <div class="elementor-widget-container">
                        <div class="qodef-shortcode qodef-m  qodef-section-title qodef-alignment--left  ">
                           <h6 class="qodef-m-tagline">
                              @if ($month_balence[0]->balence_percentage > 0)
                                 Balence Of Last 3 Month : <img src="{{asset("icons/profit.png")}}" width="30" alt="icons"> <span style="color:lawngreen">{{$month_balence[0]->balence_percentage}}%</span> - <span style="color: #14203b"> ${{number_format($month_balence[0]->balence)}} </span>
                              @else
                                 Balence Of Last 3 Month : <img src="{{asset("icons/loss.png")}}" width="30" alt="icons"> <span style="color:red">{{$month_balence[0]->balence_percentage}}%</span> - <span style="color: #14203b"> ${{number_format($month_balence[0]->balence)}} </span>
                              @endif
                           </h6>
                           <h2 class="qodef-m-title" id="time_stamp">
                              Chart of Last 3 Month 
                           </h2>
                            @foreach ($month_balence as $month)
                            <input type="hidden" class="balence_3month" value="{{$month->balence}}">
                            @endforeach
                            @foreach ($month_balence as $month)
                            <input type="hidden" class="balence_3month_dates" value="{{$month->time}}">
                            @endforeach
                           <div class="isResizable">
                                 <div class="chart-container">
                                 <canvas id="chart_3month"></canvas>
                                 </div>
                           </div>   
                           <script
                           ...
                           crossorigin="anonymous"></script>
                           <script src="{{asset("js/3month_chart.js")}}"></script>
                        </div>
                     </div>
                  </div>
                  <br>
                  <section class="elementor-section elementor-top-section elementor-element elementor-element-ba6b253 elementor-section-full_width elementor-section-height-min-height elementor-section-height-default elementor-section-items-middle qodef-elementor-content-no" data-id="ba6b253" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                     <div class="elementor-container elementor-column-gap-default">
                        <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-839fa19" data-id="839fa19" data-element_type="column">
                           <div class="elementor-widget-wrap elementor-element-populated">
                              <div class="elementor-element elementor-element-dce8cfc elementor-widget elementor-widget-text-editor" data-id="dce8cfc" data-element_type="widget" data-widget_type="text-editor.default">
                                 <div class="elementor-widget-container">
                                    <div class="row">
                                       <div class="col-3">
                                          <a class="qodef-shortcode qodef-m  qodef-button qodef-layout--outlined  qodef-html--link " href="{{route("portfolio")}}" target="_self" data-hover-color="#FFFFFF" data-hover-background-color="#161F3A" style="text-align: center;width:100%;justify-content: center;padding:10px;color: rgb(22, 31, 58); border-color: rgb(22, 31, 58); background-color: rgba(0, 0, 0, 0);">
                                             <span class="qodef-m-text">24 Hour</span>
                                          </a>
                                       </div>
                                       <div class="col-3">
                                          <a class="qodef-shortcode qodef-m  qodef-button qodef-layout--outlined  qodef-html--link " href="{{route("portfolio.week")}}" target="_self" data-hover-color="#FFFFFF" data-hover-background-color="#161F3A" style="text-align: center;width:100%;justify-content: center;padding:10px;color: rgb(22, 31, 58); border-color: rgb(22, 31, 58); background-color: rgba(0, 0, 0, 0);">
                                             <span class="qodef-m-text">7 Days</span>
                                          </a>
                                       </div>
                                       <div class="col-3">
                                          <a class="qodef-shortcode qodef-m  qodef-button qodef-layout--outlined  qodef-html--link " href="{{route("portfolio.month")}}" target="_self" data-hover-color="#FFFFFF" data-hover-background-color="#161F3A" style="text-align: center;width:100%;justify-content: center;padding:10px;color: rgb(22, 31, 58); border-color: rgb(22, 31, 58); background-color: rgba(0, 0, 0, 0);">
                                             <span class="qodef-m-text">30 Days</span>
                                          </a>
                                       </div>
                                       <div class="col-3">
                                          <a class="qodef-shortcode qodef-m  qodef-button qodef-layout--outlined  qodef-html--link " href="{{route("portfolio.year")}}" target="_self" data-hover-color="#FFFFFF" data-hover-background-color="#161F3A" style="text-align: center;width:100%;justify-content: center;padding:10px;color: rgb(22, 31, 58); border-color: rgb(22, 31, 58); background-color: rgba(0, 0, 0, 0);">
                                             <span class="qodef-m-text">1 Year</span>
                                          </a>
                                       </div>
                                    </div>
                                 </div>
                        ...
                        <div class="qodef-contact-form-7  qodef-button-layout--filled-one ">
                           <div role="form" class="wpcf7" id="wpcf7-f2376-p1936-o1" lang="en-US" dir="ltr">
                              ...
                              <table id="table" class="table table-hover" style="color:#14203b;border: 0.5px solid #14203b;">
                                 ...
                                 @if (!$asset->hasMulti())
                                    <tr>
                                       <td style="text-transform: capitalize"><img src="{{$ouricons[$i]}}" width="20" style="margin-right: 3px" alt="icon">{{$asset->token}}</td>
                                       <td>{{$asset->buy_date}}</td>
                                       <td>$ {{$asset->buy_price}}</td>
                                       <td>{{$asset->holdings}}</td>
                                       <td>$ {{number_format($asset->amount_spent)}}</td>
                                       <td>$ {{$ourprices[$i]}}</td>
                                       <td class="profit_lost" id="value_{{$asset->id}}" data-id="{{$asset->id}}" data-number="{{$asset->profit_loss_number}}"><img src="" style="display: none" id="img_{{$asset->id}}" width="18" alt="icon"> $ {{number_format($asset->profit_loss_number)}}</td>
                                       <td class="profit_lost_percentage" id="percentage_value_{{$asset->id}}" data-percetageID="{{$asset->id}}" data-percentage="{{$asset->profit_loss_number}}"><img src="" style="display: none" id="percentage_img_{{$asset->id}}" width="18" alt="icon"> {{$asset->profit_loss_percentage}}%</td>
                                    </tr>
                                 @endif
                                 @endforeach
                                 @foreach ($multiassets as $i=>$asset)
                                 <tr>
                                    <td style="text-transform: capitalize"><img src="{{$Multiouricons[$i]}}" width="20" style="margin-right: 3px" alt="icon">{{$asset->token}}</td>
                                    <td>{{$asset->buy_date}}</td>
                                    <td>$ {{$asset->buy_price}}</td>
                                    <td>{{number_format($asset->holdings)}}</td>
                                    <td>$ {{number_format($asset->amount_spent)}}</td>
                                    <td>$ {{$Multiourprices[$i]}}</td>
                                    <td class="profit_lost" id="value_{{$asset->id}}" data-id="{{$asset->id}}" data-number="{{$asset->profit_loss_number}}"><img src="" style="display: none" id="img_{{$asset->id}}" width="18" alt="icon"> $ {{number_format($asset->profit_loss_number)}}</td>
                                    <td class="profit_lost_percentage" id="percentage_value_{{$asset->id}}" data-percetageID="{{$asset->id}}" data-percentage="{{$asset->profit_loss_number}}"><img src="" style="display: none" id="percentage_img_{{$asset->id}}" width="18" alt="icon"> {{$asset->profit_loss_percentage}}%</td>
                                 </tr>
                                 @endforeach
                              ...
                              <div class="table-responsive">
                                 <table id="mobile_table" class="table table-hover" style="width:auto;margin-left:auto;margin-right:auto;color:#14203b;">
                                    ...
                                    @if (!$asset->hasMulti())
                                       <tr>
                                          <td style="text-transform: capitalize;vertical-align: middle;justify-content: center"><img src="{{$ouricons[$i]}}" width="15" style="margin-right: 3px" alt="icon">{{$asset->token}}</td>
                                          <td style="vertical-align: middle;">${{number_format($ourprices[$i])}}</td>
                                          <td style="vertical-align: middle;">{{$asset->holdings}}</td>
                                          <td style="vertical-align: middle;" class="mobile_profit_lost_percentage" id="mobile_percentage_value_{{$asset->id}}" data-percetageID-mobile="{{$asset->id}}" data-percentage-mobile="{{$asset->profit_loss_number}}"><img src="" style="display: none" id="mobile_percentage_img_{{$asset->id}}" width="13" alt="icon"> {{$asset->profit_loss_percentage}}%</td>
                                       </tr>
                                    @endif
                                    @endforeach
                                    ...
                                    @foreach ($multiassets as $i=>$asset)
                                       <tr>
                                          <td style="text-transform: capitalize;vertical-align: middle;"><img src="{{$Multiouricons[$i]}}" width="15" style="margin-right: 3px" alt="icon">{{$asset->token}}</td>
                                          <td style="vertical-align: middle;">${{number_format($Multiourprices[$i])}}</td>
                                          <td style="vertical-align: middle;">{{$asset->holdings}}</td>
                                          <td style="vertical-align: middle;" class="mobile_profit_lost_percentage" id="mobile_percentage_value_{{$asset->id}}" data-percetageID-mobile="{{$asset->id}}" data-percentage-mobile="{{$asset->profit_loss_number}}"><img src="" style="display: none" id="mobile_percentage_img_{{$asset->id}}" width="13" alt="icon"> {{$asset->profit_loss_percentage}}%</td>
                                       </tr>
                                    @endforeach
