                     ...
                     <div class="elementor-widget-container">
                        <div class="qodef-shortcode qodef-m  qodef-section-title qodef-alignment--left  ">
                           <h6 class="qodef-m-tagline">
                              @if ($week_balence[0]->balence_percentage > 0)
                                 Balence Of Last Week : <img src="{{asset("icons/profit.png")}}" width="30" alt="icons"> <span style="color:lawngreen">{{$week_balence[0]->balence_percentage}}%</span> - <span style="color: #14203b"> ${{number_format($week_balence[0]->balence)}} </span>
                              @else
                                 Balence Of Last Week : <img src="{{asset("icons/loss.png")}}" width="30" alt="icons"> <span style="color:red">{{$week_balence[0]->balence_percentage}}%</span> - <span style="color: #14203b"> ${{number_format($week_balence[0]->balence)}} </span>
                              @endif
                           </h6>
                           <h2 class="qodef-m-title" id="time_stamp">
                              Chart of Last 7 Days
                           </h2>
                            @foreach ($week_balence as $week)
                            <input type="hidden" class="balence_week" value="{{$week->balence}}">
                            @endforeach
                            @foreach ($week_balence as $week)
                            <input type="hidden" class="balence_week_dates" value="{{$week->time}}">
                            @endforeach
                           ...
                           crossorigin="anonymous"></script>
                           <script src="{{asset("js/week_chart.js")}}"></script>
                        </div>
                     </div>
                  </div>
                  <br>
                              ...
                              <div class="elementor-element elementor-element-dce8cfc elementor-widget elementor-widget-text-editor" data-id="dce8cfc" data-element_type="widget" data-widget_type="text-editor.default">
                                 <div class="elementor-widget-container">
                                    <div class="row">
                                       ...
                                       <div class="col-3">
                                          <a class="qodef-shortcode qodef-m  qodef-button qodef-layout--outlined  qodef-html--link " href="{{route("portfolio.3_month")}}" target="_self" data-hover-color="#FFFFFF" data-hover-background-color="#161F3A" style="text-align: center;width:100%;justify-content: center;padding:10px;color: rgb(22, 31, 58); border-color: rgb(22, 31, 58); background-color: rgba(0, 0, 0, 0);">
                                             <span class="qodef-m-text">90 Days</span>
                                          </a>
                                       </div>
