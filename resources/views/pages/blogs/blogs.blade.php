    ...
    <div style="background: #00acd4" class="qodef-page-title qodef-m qodef-title--standard-with-breadcrumbs qodef-alignment--left qodef-vertical-alignment--header-bottom">
       <div class="qodef-m-inner">
          <div class="qodef-m-content qodef-content-grid ">
             ...
             <div itemprop="breadcrumb" class="qodef-breadcrumbs"><a itemprop="url" class="qodef-breadcrumbs-link" href="{{route("index")}}"><span itemprop="title">Home</span></a><span class="qodef-breadcrumbs-separator"></span><span itemprop="title" class="qodef-breadcrumbs-current">Blogs</span></div>
          </div>
       </div>
    </div>
                                                 ...
                                                 <div class="qodef-e-inner">
                                                    <div class="qodef-e-media">
                                                       <div class="qodef-e-media-image">
                                                          <a itemprop="url" href="{{$blog->show()}}">
                                                          <img width="1300" height="761" src="{{$blog->cover()}}" class="attachment-full size-full wp-post-image" alt="L" srcset="{{$blog->cover()}} 1300w, {{$blog->cover()}} 600w, {{$blog->cover()}} 800w, {{$blog->cover()}} 300w, {{$blog->cover()}} 1024w, {{$blog->cover()}} 768w" sizes="(max-width: 1300px) 100vw, 1300px" /> </a>
                                                       </div>
                                                    </div>
                                                    <div class="qodef-e-content">
                                                       ...
                                                       <div class="qodef-e-text">
                                                          <h2 itemprop="name" class="qodef-e-title entry-title">
                                                             <a itemprop="url" class="qodef-e-title-link" href="{{$blog->show()}}">
                                                             {{$blog->title}}	</a>
                                                          </h2>
                                                          <p itemprop="description" class="qodef-e-excerpt">{{$blog->short_des}}</p>
                                                       </div>
                                                       <div class="qodef-e-bottom-holder">
                                                          <div class="qodef-e-left">
                                                             <div class="qodef-e-read-more">
                                                                <a class="qodef-shortcode qodef-m  qodef-button qodef-layout--textual  qodef-html--link " href="{{$blog->show()}}" target="_self">
