...
<html lang="en-US" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#">
   <head>
      ...
      {!! SEO::generate() !!}
      <title>Introducing innovative ideas for business &#8211; Halstein</title>
      ...
      <link rel="pingback" href="https://halstein.qodeinteractive.com/xmlrpc.php">
      ...
      <link rel="alternate" type="application/rss+xml" title="Halstein &raquo; Introducing innovative ideas for business Comments Feed" href="https://halstein.qodeinteractive.com/introducing-innovative-ideas-for-business/feed/" />
    ...
    <div style="background: #00acd4" class="qodef-page-title qodef-m qodef-title--breadcrumbs qodef-alignment--left qodef-vertical-alignment--header-bottom">
        <div class="qodef-m-inner">
           <div class="qodef-m-content qodef-content-grid ">
              ...
              <div itemprop="breadcrumb" class="qodef-breadcrumbs"><a itemprop="url" class="qodef-breadcrumbs-link" href="{{route("index")}}"><span itemprop="title">Home</span></a><span class="qodef-breadcrumbs-separator"></span><a href="{{route('tutorials')}}">Tutorials</a><span class="qodef-breadcrumbs-separator"></span><span itemprop="title" class="qodef-breadcrumbs-current">{{$tutorial->name}}</span></div>
           </div>
        </div>
     </div>
                      ...
                      <div class="qodef-e-inner">
                         <div class="qodef-e-media">
                            <div class="qodef-e-media-image">
                               <img width="1300" height="761" src="{{$tutorial->cover()}}" class="attachment-full size-full wp-post-image" alt="L" srcset="{{$tutorial->cover()}} 1300w, {{$tutorial->cover()}} 600w, {{$tutorial->cover()}} 800w, {{$tutorial->cover()}} 300w, {{$tutorial->cover()}} 1024w, {{$tutorial->cover()}} 768w" sizes="(max-width: 1300px) 100vw, 1300px" /> 
                            </div>
                         </div>
                         <div class="qodef-e-content">
                            <div class="qodef-e-top-holder">
                               <div class="qodef-e-info">
                                  <a itemprop="dateCreated" href="{{$tutorial->show()}}" class="entry-date published updated">
