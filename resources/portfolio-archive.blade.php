                        ...
                        <div class="qodef-shortcode qodef-m  qodef-section-title qodef-alignment--left  ">
                           <div class="isResizable" style="height: auto">
                                 <div class="chart-container">
                                    <canvas id="myChart" style="width: 70%;display: block;margin-left:auto;margin-right:auto" ></canvas>
                                 </div>
                           </div>   
                           ...
                           <script>
                              const data = {
                                 ...
                                 datasets: [{
                                    ...
                                    data: [300, 50, 100,200,300,550,122,453,50],
                                    backgroundColor: [
                                       'grey',
                                       'darkblue',
                                       'blue',
                                       "pink","brown","red","green","purple"
                                    ],
                                    hoverOffset: 4
                                 }]
                              };
